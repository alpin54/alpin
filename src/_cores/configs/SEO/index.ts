...
const DefaultSEO = {
	...
	description:
		"Frontend developer in Kuningan, Indonesia. Building thoughtful, scalable web experiences with React, Next.js, and design systems.",
	keywords: "Alpin — Frontend Developer",
	timeRefresh: 900,
