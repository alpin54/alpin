...
export default function HeroSection() {
	return (
		<section className={[styles["hero"], "section-wrap"].join(" ")} id="home">
			...
			<div className={styles["hero-art"]}>
				...
				<div className={styles["portrait"]}>
					<Image
						...
						objectFit="cover"
					/>
					{/* <div className={styles["portrait-head"]} />
          <div className={styles["portrait-body"]} />
          <span className={styles["portrait-initial"]}>A.</span> */}
				</div>
